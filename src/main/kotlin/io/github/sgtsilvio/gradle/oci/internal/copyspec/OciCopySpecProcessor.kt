...
private fun visitParentDirectories(parentDirectoryVisitors: LinkedList<() -> Unit>) {
    for (parentDirectoryVisitor in parentDirectoryVisitors) {
        parentDirectoryVisitor()
    }
    parentDirectoryVisitors.clear()
}
